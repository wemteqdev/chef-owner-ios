...
class DetailPage: UIViewController{
    ...
    private func addOrderTotalView () {
        ...
        monthlyOrderView.orderDescription.text = "This Month - August"
        ...
        creditNotesView.orderDescription.text = "This Month - August"
        ...
        totalOrderView.orderDescription.text = "This Month - August"
        totalOrderView.ordersCount.text = "$30,854.87"
        ...
        deliveryView.orderDescription.text = "This Month - August"
        deliveryView.ordersCount.text = "10"
        
        pendingView.orderName.text = "Pending Delivery"
        pendingView.orderDescription.text = "This Month - August"
        pendingView.orderDescription.textColor = UIColor.red;
        pendingView.ordersCount.textColor = UIColor.red;
        pendingView.ordersCount.text = "10"
