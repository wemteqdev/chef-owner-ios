...
- (void)showTop:(BOOL)showTop {
    if(showTop){
        self.visibleVerticalLayoutConstraintsPositionVisible = @"V:|-(5)-[self(50)]";
        self.visibleVerticalLayoutConstraintsPositionHidden = @"V:|-(-50)-[self(50)]";
    } else{
        self.visibleVerticalLayoutConstraintsPositionVisible = @"V:[self(50)]-(5)-|";
        self.visibleVerticalLayoutConstraintsPositionHidden = @"V:[self(50)]-(-50)-|";
    }
}
...
//    [constraints addObjectsFromArray:
//     [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-0-|"
//                                             options:0
//                                             metrics:nil
